...
import { ContactRole } from '../../../../crm/interfaces/lead-creation.interface';
...
export class ContactRolesListComponent implements OnInit {
  ...
  createContactRole() {
    ...
    this.router.navigate(['/masters/crm/contact-roles/create']);
  }

  editContactRole(role: ContactRoleExtended) {
    // Navigate to edit form
    this.router.navigate(['/masters/crm/contact-roles/edit', role.roleId]);
  }
