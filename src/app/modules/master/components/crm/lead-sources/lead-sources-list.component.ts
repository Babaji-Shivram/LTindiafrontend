...
import { LeadSource } from '../../../../crm/interfaces/lead-creation.interface';
...
export class LeadSourcesListComponent implements OnInit {
  ...
  createLeadSource() {
    ...
    this.router.navigate(['/masters/crm/lead-sources/create']);
  }

  editLeadSource(source: LeadSourceExtended) {
    // Navigate to edit form
    this.router.navigate(['/masters/crm/lead-sources/edit', source.leadSourceId]);
  }
