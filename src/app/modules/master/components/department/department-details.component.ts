    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div class="border-b border-gray-200 px-6 py-4">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-xl font-semibold text-gray-900">Department Details</h1>
      ...
      <div *ngIf="!isLoading && department" class="p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <div class="mt-1 text-lg font-semibold text-gray-900">{{ department.DepartmentName }}</div>
                </div>
          ...
          <div class="space-y-6">
            <div>
              <h2 class="text-lg font-semibold text-gray-900 mb-4">Organizational Information</h2>
              <div class="space-y-4">
                <div>
