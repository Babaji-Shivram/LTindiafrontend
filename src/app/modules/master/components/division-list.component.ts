      ...
      <div class="border-b border-gray-200 px-6 py-4">
        <div class="flex items-center justify-between">
          ...
          <button 
            ...
            class="bg-[#2c4170] hover:bg-[#1e2d4f] text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
            Add Division
          </button>
        </div>
      </div>
        ...
        <div class="flex flex-wrap items-center gap-4">
          <div class="flex-1 min-w-[200px]">
            <input
              ...
              class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#2c4170] focus:border-[#2c4170]">
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <select 
              ...
              (change)="applyFilters()"
              class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#2c4170] focus:border-[#2c4170]">
            ...
            <tr *ngFor="let division of filteredDivisions; trackBy: trackByDivision" 
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="text-sm font-medium text-gray-900">{{ division.DivisionName }}</div>
                  </div>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
