...
public partial class VwJobDetail
{
    ...
    public string? ChecklistRequestRemark { get; set; }

    public string? ChecklistAuditRemark { get; set; }
    ...
    public string? BillingAdvCompletedDate { get; set; }
    ...
    public string? ProductInvoiceQuantity { get; set; }

    public decimal? ProductAssessableValue { get; set; }

    public decimal? ProductBasicDuty { get; set; }

    public decimal? ProductBasicDutyRate { get; set; }

    public decimal? ProductCessAmount { get; set; }

    public decimal? ProductCessRate { get; set; }

    public decimal? ProductGstDutyAmount { get; set; }

    public decimal? ProductGstDutyRate { get; set; }
    ...
    public decimal? SchemeLicenceAmount { get; set; }
}
