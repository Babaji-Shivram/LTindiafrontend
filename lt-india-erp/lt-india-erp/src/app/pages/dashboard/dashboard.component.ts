        ...
        <div *ngFor="let metric of dashboardMetrics" class="bg-white rounded-lg shadow border border-gray-200 p-6">
          <div class="flex items-center justify-between">
            ...
            <div [class]="getMetricIconClass(metric.icon)">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" [innerHTML]="getIconSvg(metric.icon)">
              </svg>
            </div>
          </div>
          ...
          <div class="space-y-3">
            <button *ngFor="let action of quickActions" 
              ...
              <div [class]="action.iconClass">
                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20" [innerHTML]="action.icon">
                </svg>
              </div>
              <div>
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div *ngFor="let item of recentlyVisited" 
            ...
            <div class="flex items-center space-x-2">
              <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20" [innerHTML]="item.icon">
              </svg>
...
export class DashboardComponent implements OnInit {
  ...
  getIconSvg(icon: string): string {
    switch (icon) {
      ...
      case 'server':
        return '<path fill-rule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm14 1a1 1 0 11-2 0 1 1 0 012 0zM2 13a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 01-2 2H4a2 2 0 01-2-2v-2zm14 1a1 1 0 11-2 0 1 1 0 012 0z" clip-rule="evenodd"/>';
      case 'database':
        return '<path d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4"/>';
      default:
