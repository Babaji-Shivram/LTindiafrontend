...
import { BusinessCategory } from '../../../interfaces/lead-creation.interface';
...
export class BusinessCategoriesListComponent implements OnInit {
  ...
  createBusinessCategory() {
    ...
    this.router.navigate(['/crm/masters/business-categories/create']);
  }

  editBusinessCategory(category: BusinessCategoryExtended) {
    // Navigate to edit form
    this.router.navigate(['/crm/masters/business-categories/edit', category.businessCategoryId]);
  }
