...
import { Service } from '../../../interfaces/lead-creation.interface';
...
export class ServicesListComponent implements OnInit {
  ...
  createService() {
    ...
    this.router.navigate(['/crm/masters/services/create']);
  }

  editService(service: ServiceExtended) {
    // Navigate to edit form
    this.router.navigate(['/crm/masters/services/edit', service.serviceId]);
  }
