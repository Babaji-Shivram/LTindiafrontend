...
import { CompanyType } from '../../../../crm/interfaces/lead-creation.interface';
...
export class CompanyTypesListComponent implements OnInit {
  ...
  onAddNew() {
    this.router.navigate(['/masters/crm/company-types/new']);
  }

  onEdit(companyType: CompanyType) {
    this.router.navigate(['/masters/crm/company-types/edit', companyType.companyTypeId]);
  }

  onView(companyType: CompanyType) {
    this.router.navigate(['/masters/crm/company-types', companyType.companyTypeId]);
  }
