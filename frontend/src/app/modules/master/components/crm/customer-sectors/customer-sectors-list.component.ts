...
import { CustomerSector } from '../../../../crm/interfaces/lead-creation.interface';
...
export class CustomerSectorsListComponent implements OnInit {
  ...
  onAddNew() {
    this.router.navigate(['/masters/crm/customer-sectors/new']);
  }

  onEdit(sector: CustomerSector) {
    this.router.navigate(['/masters/crm/customer-sectors/edit', sector.sectorId]);
  }

  onView(sector: CustomerSector) {
    this.router.navigate(['/masters/crm/customer-sectors', sector.sectorId]);
  }
