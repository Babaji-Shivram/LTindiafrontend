        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="page-title text-gray-900">{{ getTotalLeads() }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="page-title text-gray-900">{{ getQualifiedLeads() }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="page-title text-gray-900">{{ getProposalLeads() }}</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="page-title text-gray-900">\${{ getTotalValue() }}K</p>
            </div>
